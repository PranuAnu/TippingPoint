 ...
 */
 void opcontrol() {
  ...
  pros::lcd::set_text(0, "opcontrol has started!");
	...
	pros::Task Roller(Roller_fn, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "My Task");
	/*pros::Task RollerUpper(RollerUpper_fn, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "My Task");*/
